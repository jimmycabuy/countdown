...
<header class="flex items-start justify-between gap-6 pt-10 pb-10 md:pb-14">
	...
	{#if onAdd}
		<button
			type="button"
			class="focus-ring animate-fadeUp rounded-full border border-white/10 px-5 py-3 text-[0.68rem] font-semibold text-lavender uppercase opacity-0 transition hover:border-lavender/25 hover:bg-lavender/8"
			onclick={onAdd}
		>
			Add countdown
		</button>
